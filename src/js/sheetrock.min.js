                    ...
                    ((e.target = (function (t) {
                        ...
                        return (
                            "object" == typeof e &&
                                ...
                                e.length &&
                                ([e] = e),
                            e && e.nodeType && 1 === e.nodeType ? e : null
                        );
                    })(t.target)),
                ...
                (this.request = (function (t, e) {
                    ...
                    if (
                        (Object.keys(n).forEach((e) => {
                            const r = n[e];
                            r.keyFormat.test(t.url) &&
                                r.gidFormat.test(t.url) &&
                                (s = r);
                        }),
                        s)
                    ) {
                        ...
                        return {
                            key: e,
                            gid: t.url.match(s.gidFormat)[1],
                            apiEndpoint: s.apiEndpoint.replace("%key%", e),
                        };
                    }
    ...
    class d {
        constructor(t) {
            if (
                ...
                throw new u("A previous request for this resource failed.");
        ...
        get url() {
            const t = this.options.user.fetchSize,
                ...
                s = [
                    ...
                    `tq=${encodeURIComponent(this.options.user.query + e)}`,
                ];
    ...
    class p {
        ...
        setAttributes() {
            ...
            this.request.state.offset ||
                ...
                this.request.update({
                    header: r.rowNumberOffset,
                    labels: o,
                    offset: this.request.state.offset + r.rowNumberOffset,
                })),
                (!t || e.length - r.rowNumberOffset < t) &&
                    ((r.last += 1), this.request.update({ loaded: !0 }));
        ...
        setOutput() {
            (this.rows = []),
                this.request.state.offset ||
                    this.attributes.rowNumberOffset ||
                    this.rows.push(
                        new f(0, this.attributes.labels, this.attributes.labels)
                    ),
                ...
                this.request.update({
                    offset:
                        this.request.state.offset + this.options.user.fetchSize,
                });
        }
        setHTML() {
